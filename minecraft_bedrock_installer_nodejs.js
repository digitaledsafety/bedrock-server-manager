...
/**
 * Validates a backup name to prevent path traversal, control characters, and unsafe patterns.
...
export function isValidBackupName(backupName) {
    ...
    if (backupName.includes('.') || backupName.includes('/') || backupName.includes('\\') || !backupNameRegex.test(backupName)) {
        return false;
    }
    return true;
}
